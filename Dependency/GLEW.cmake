...
set(HookBill_GLEW_INCLUDE_DIR "")
set(HookBill_GLEW_TARGET_NAME "")
if (NOT WIN32 AND NOT EMSCRIPTEN)
    # on    Mac : brew install glew
    # on Ubuntu : apt install libglew-dev
    set(GLEW_USE_STATIC_LIBS TRUE)
    find_package(GLEW REQUIRED)
    set(HookBill_GLEW_INCLUDE_DIR ${GLEW_INCLUDE_DIRS})
    set(HookBill_GLEW_TARGET_NAME GLEW::glew_s)
elseif(WIN32)
    ...
    set(HookBill_GLEW_INCLUDE_DIR ${glew_SOURCE_DIR}/include)
    ...
    set(HookBill_GLEW_TARGET_NAME the_glew)
endif()

add_library(HookBill_GLEW INTERFACE)
target_link_libraries(HookBill_GLEW INTERFACE ${HookBill_GLEW_TARGET_NAME} $<$<PLATFORM_ID:Linux>:GL>)
target_include_directories(HookBill_GLEW SYSTEM INTERFACE ${HookBill_GLEW_INCLUDE_DIR})
target_compile_definitions(HookBill_GLEW INTERFACE GLEW_STATIC)